...
const props = defineProps({
  ...
  renderParams: {
    type: Object as PropType<VxeGlobalRendererHandles.RenderFormDesignWidgetFormViewParams<FormDesignWidgetCreateByProps>>,
    default: () => ({})
  }
})
const { currWidget, widgetOptions } = useWidgetView<FormDesignWidgetCreateByProps>(props)
</script>
