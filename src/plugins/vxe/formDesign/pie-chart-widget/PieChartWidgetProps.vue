...
const props = defineProps({
  ...
  renderParams: {
    type: Object as PropType<VxeGlobalRendererHandles.RenderFormDesignWidgetFormViewParams<FormDesignWidgetPieChartProps>>,
    default: () => ({})
  }
})

const { currWidget, widgetOptions } = useWidgetView<FormDesignWidgetPieChartProps>(props)
</script>
